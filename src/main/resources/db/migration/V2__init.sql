...
CREATE INDEX IF NOT EXISTS posts_path1_thread_idx ON Posts (thread, (path [1]), path, id);
...
CREATE INDEX IF NOT EXISTS posts_thread_parent1_id_idx ON Posts(thread, (path[1]), parent, id);